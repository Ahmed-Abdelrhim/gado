                    ...
                    @if(auth()->guard('customer')->check() || auth()->guard('dealer')->check())
                        <div class="dropdown login_btns_with_auth">
                            <button class="dropdown-toggle" type="button" id="dropdownMenuButton1"
                                ...
                                <img src="{{asset('dist/front/assets/images/icons/user.svg')}}" alt="" height="" width="" />
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                <li>
                                    <a class="dropdown-item" href="{{ auth()->guard('customer')->check() ? route('customer.profile') : route('dealer.profile') }}">
                                        <img src="{{asset('dist/front/assets/images/icons/setting.svg')}}" alt="" height="" width="" />
                                        {{ __('messages.Profile') }}
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="{{ route('front_my_orders',['div'=>$div]) }}">
                                        <img src="{{asset('dist/front/assets/images/icons/cart_p.svg')}}" alt="" height="" width="" />
                                        {{ __('messages.My_Orders') }}
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="{{ auth()->guard('customer')->check() ? route('customer.logout') : route('dealer.logout') }}">
                                        <img src="{{asset('dist/front/assets/images/icons/logout.svg')}}" alt="" height="" width="" />
                                        {{ __('messages.log_out') }}
                                    </a>
                                </li>
                            </ul>
                    ...
                    @if(!auth()->guard('customer')->check() && !auth()->guard('dealer')->check())
                        <div class="login_btns">
                            ...
                            <ul>
                                ...
                                <li>/</li>
                                <li><a href="{{ route('front.verify_phone') }}">{{ __('messages.Create_account') }} </a></li>
                            </ul>
                        </div>
                    @endif
                </div>
    ...
    <div class="center_header" style="background-color:#fff; color:#0a458b;">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="logo_site">
                    <a href="{{route('front.home','1')}}"> <img src="{{asset('dist/front/assets/images/logo/logo2.png')}}" alt="" height="" width=""></a>
                </div>
                ...
                <div class="search_site">
                    <form action="{{route('front_nav_search',['div'=>$div])}}">
                        <div class="form-group">
                            ...
                            <button type="submit" class="searchSubmit"><img src="{{asset('dist/front/assets/images/icons/search.svg')}}" alt="" width=""
                                    height="" /> </button>
                        </div>
                    </form>
                </div>
                ...
                <div class="wishlist_cart">
                    <div class="wishlist_icon">
                        ...
                        <a  style="background-color:#fff; color:#0a458b;" href="{{ route('front_favourit_list',['div'=>$div]) }}">
                        @else
                        <a  style="background-color:#fff; color:#0a458b;" href="{{ route('front.login') }}">
                        @endif
                            <img src="{{asset('dist/front/assets/images/icons/heart.svg')}}" style="filter: grayscale(100%);" alt="" width="" height="" />
                            @if(auth()->guard('customer')->check() || auth()->guard('dealer')->check())
                    ...
                    <div class="cart_icon"  style="background-color:#fff; color:#0a458b;">
                        ...
                        <a href="{{ route('front_home_cart',['div'=>$div]) }}">
                            <div>
                                <img src="{{asset('dist/front/assets/images/icons/cart.svg')}}" alt="" width="" height="" />
        ...
        <div class="container">
            <nav class="main_menu">
                <ul>
                    ...
                    <li><a href="{{ route('front_show_more', ['div'=>$div,'kind'=>'2']) }}">  {{ __('messages.best_seller') }}</a></li>
                    <li>
                    <div class="login_lang">
                    <div class="dropdown">
                        <button class="dropdown-toggle" type="button" id="dropdownMenuButton1"
                        ...
                        @if(isset($data))
                            @if(isset($data->Categories))
                                @foreach($data->Categories as $value)
                                    <li>
                                        <a class="dropdown-item" href="{{ route('front_show_more', ['div'=>$div,'id'=>$value->id]) }}">
...
@if($div == 2)
    ...
    <div class="center_header">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center">
            <div class="logo_site">
                    <a href="{{route('front.home','2')}}">  <img src="{{asset('dist/front/assets/images/logo/logo.png')}}" alt="" height="" width=""></a>
                </div>
                ...
                <div class="wishlist_cart">
                    <div class="wishlist_icon">
                        ...
                        @endif
                            <img src="{{asset('dist/front/assets/images/icons/heart.svg')}}" alt="" width="" height="" />
                            @if(auth()->guard('customer')->check() || auth()->guard('dealer')->check())
                            @if(auth()->guard('dealer')->check())
                            <small class="favvv">{{count(auth()->guard('dealer')->user()->ProLikes)}}</small>
                            @else
